...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal">Chat Room</h1>
    <p class="lead font-weight-normal">Chat with your friends without worrying anything</p>
    <form action="claim.php" method="post">
    <input type="text" placeholder="Enter Your Room Name" class="form-control" name="room"/><br><input type="submit" class="btn btn-outline-secondary" href="#" value="Make a Room"></button>
      </form> 
  </div>
